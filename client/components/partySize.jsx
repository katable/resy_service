...
const PartySize = ({ partySize, handleChangeParty }) => (
  <div style={{ flex: '1 50%' }}>
    ...
    <div style={{ height: '35px', position: 'relative' }}>
      <div style={{ position: 'absolute' }}>For {partySize}</div>
      ...
      <select value={partySize} onChange={handleChangeParty} style={{ height: '35px', width: '100%', backgroundColor: 'transparent', color: 'transparent', WebkitAppearance: 'none' }}>
