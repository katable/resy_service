...
const Time = ({ dateTime, handleChangeTime }) => (
  <div style={{ flex: '1 50%' }}>
    ...
    <div style={{ height: '35px', position: 'relative' }}>
      <div style={{ position: 'absolute' }}>{numStrToTimeAMPM(dateTime)}</div>
      ...
      <select value={numStrToTimeAMPM(dateTime)} onChange={handleChangeTime} style={{ height: '35px', width: '100%', backgroundColor: 'transparent', color: 'transparent', WebkitAppearance: 'none' }}>
